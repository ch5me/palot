...
> **Companion to:** `docs/loom-implementation-plan.md` (the *what* and *why*)
> and `docs/loom-progress.md` (the *status*). This directory is the *how*.
...
- Each prompt cites the relevant section of `docs/loom-implementation-plan.md`
  and `docs/loom-alignment-assessment.md`. The worker should load those
  docs as context.
- The "Definition of done" includes a `docs/loom-progress.md` update.
