...
> **Plan section:** `docs/loom-implementation-plan.md` §3 Phase 6.
> **Assessment anchor:** `docs/loom-alignment-assessment.md` §4.4
...
- `docs/loom-progress.md` is updated with `Wave 6: complete (date)`.
...
- A follow-up note in `docs/loom-progress.md` flags the
