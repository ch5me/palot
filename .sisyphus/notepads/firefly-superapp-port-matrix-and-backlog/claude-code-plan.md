...
## Current Palot seams <!-- oc:id=sec_ab -->
...
- There is no separate Claude-Code-specific runtime or interactive session substrate in Palot.
...
- The concrete value already present in Palot is migration + compatibility, not a second live agent workflow.
...
- live Claude Code session runtime inside Palot
