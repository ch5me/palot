...
const items = [
	{
		id: "shell",
		title: "Shell audit",
		subtitle: "nav and chrome proof",
		src: tile("#0f766e", "#2563eb", "Shell"),
	},
	{
		id: "voice",
		title: "Voice tools",
		subtitle: "mic and selector states",
		src: tile("#9f1239", "#f97316", "Voice"),
	},
	{
		id: "motion",
		title: "Motion kit",
		subtitle: "animated layouts",
		src: tile("#312e81", "#a855f7", "Motion"),
	},
]
